...
@WebServlet(name = "addClientRegistration", urlPatterns = {"/addClientRegistration"})
public class addClientRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (i > 0) {
                request.setAttribute("register", "Client Registration successful..");
